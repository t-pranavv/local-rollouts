...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tunes a model with GRPO and Ray.")
...
if __name__ == "__main__":
    ...
    tuning_args = get_tuning_args(config["output_dir"], framework="ray", task="grpo", **config["tuning_args"])
    ...
    # `get_dataset` creates a dictionary of evaluation datasets, but GRPO only
