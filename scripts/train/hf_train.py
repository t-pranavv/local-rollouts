...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Trains/fine-tunes with Hugging Face.")
...
if __name__ == "__main__":
    ...
    training_args = get_training_args(config["output_dir"], framework="hf", **config["training_args"])
